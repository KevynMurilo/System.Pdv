...
namespace System.Pdv.Infrastructure.Migrations
{
    ...
    [Migration("20240917124956_AddAdminRolePermissions")]
    partial class AddAdminRolePermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissaoRole", b =>
                {
                    b.HasOne("System.Pdv.Core.Entities.Permissao", null)
                        .WithMany()
                        .HasForeignKey("PermissoesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("System.Pdv.Core.Entities.Role", null)
                        .WithMany()
