...
public class DeleteStatusPedidoService : IDeleteStatusPedidoService
{
    private readonly IStatusPedidoRepository _statusPedidoRepository;
    private readonly ILogger<DeleteStatusPedidoService> _logger;

    public DeleteStatusPedidoService(IStatusPedidoRepository statusPedidoRepository, ILogger<DeleteStatusPedidoService> logger)
    {
