...
public class GetByIdMetodoPagamentoServiceTests
{
    ...
    private readonly Mock<ILogger<GetByIdMetodoPagamentoService>> _loggerMock;
    private readonly GetByIdMetodoPagamentoService _service;

    public GetByIdMetodoPagamentoServiceTests()
    {
        _metodoPagamentoRepositoryMock = new Mock<IMetodoPagamentoRepository>();
        _loggerMock = new Mock<ILogger<GetByIdMetodoPagamentoService>>();
        _service = new GetByIdMetodoPagamentoService(_metodoPagamentoRepositoryMock.Object, _loggerMock.Object);
    }
