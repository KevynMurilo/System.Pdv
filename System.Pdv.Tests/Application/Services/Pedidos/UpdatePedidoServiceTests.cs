...
public class UpdatePedidoServiceTests
{
    ...
    private readonly Mock<ILogger<UpdatePedidoService>> _loggerMock;
    private readonly UpdatePedidoService _updatePedidoService;
    ...
    public UpdatePedidoServiceTests()
    {
        ...
        _loggerMock = new Mock<ILogger<UpdatePedidoService>>();

        _updatePedidoService = new UpdatePedidoService(
