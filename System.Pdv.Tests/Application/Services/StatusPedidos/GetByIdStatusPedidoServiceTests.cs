...
public class GetByIdStatusPedidoServiceTests
{
    ...
    private readonly Mock<ILogger<GetByIdStatusPedidoService>> _loggerMock;
    private readonly GetByIdStatusPedidoService _service;

    public GetByIdStatusPedidoServiceTests()
    {
        _statusPedidoRepositoryMock = new Mock<IStatusPedidoRepository>();
        _loggerMock = new Mock<ILogger<GetByIdStatusPedidoService>>();
        _service = new GetByIdStatusPedidoService(_statusPedidoRepositoryMock.Object, _loggerMock.Object);
    }
