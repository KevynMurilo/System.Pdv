...
public class DeleteStatusPedidoServiceTests
{
    ...
    private readonly Mock<ILogger<DeleteStatusPedidoService>> _loggerMock;
    private readonly DeleteStatusPedidoService _service;

    public DeleteStatusPedidoServiceTests()
    {
        _statusPedidoRepositoryMock = new Mock<IStatusPedidoRepository>();
        _loggerMock = new Mock<ILogger<DeleteStatusPedidoService>>();
        _service = new DeleteStatusPedidoService(_statusPedidoRepositoryMock.Object, _loggerMock.Object);
    }
