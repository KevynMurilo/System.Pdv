...
public class DeleteAdicionalServiceTests
{
    ...
    private readonly Mock<ILogger<DeleteAdicionalService>> _loggerMock;
    private readonly DeleteAdicionalService _deleteAdicionalService;

    public DeleteAdicionalServiceTests()
    {
        _adicionalRepositoryMock = new Mock<IAdicionalRepository>();
        _loggerMock = new Mock<ILogger<DeleteAdicionalService>>();
        _deleteAdicionalService = new DeleteAdicionalService(_adicionalRepositoryMock.Object, _loggerMock.Object);
    }
    ...
    public async Task DeleteAdicional_ShouldReturnNotFound_WhenAdicionalDoesNotExist()
    {
        ...
        var result = await _deleteAdicionalService.DeleteAdicional(adicionalId);
