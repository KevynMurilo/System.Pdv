...
public class CreateUsuarioServiceTests
{
    ...
    private readonly Mock<ILogger<CreateUsuarioUseCase>> _loggerMock;
    private readonly CreateUsuarioUseCase _createUsuarioService;

    public CreateUsuarioServiceTests()
    {
        _usuarioRepositoryMock = new Mock<IUsuarioRepository>();
        _roleRepositoryMock = new Mock<IRoleRepository>();
        _loggerMock = new Mock<ILogger<CreateUsuarioUseCase>>();
        _createUsuarioService = new CreateUsuarioUseCase(_usuarioRepositoryMock.Object, _roleRepositoryMock.Object, _loggerMock.Object);
    }
