...
public class UpdateAdicionalServiceTests
{
    ...
    private readonly Mock<ILogger<UpdateAdicionalUseCase>> _loggerMock;
    private readonly UpdateAdicionalUseCase _updateAdicionalService;

    public UpdateAdicionalServiceTests()
    {
        _adicionalRepositoryMock = new Mock<IAdicionalRepository>();
        _loggerMock = new Mock<ILogger<UpdateAdicionalUseCase>>();
        _updateAdicionalService = new UpdateAdicionalUseCase(_adicionalRepositoryMock.Object, _loggerMock.Object);
    }
