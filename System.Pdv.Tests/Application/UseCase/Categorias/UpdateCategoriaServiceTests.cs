...
public class UpdateCategoriaServiceTests
{
    ...
    private readonly Mock<ILogger<UpdateCategoriaUseCase>> _loggerMock;
    private readonly UpdateCategoriaUseCase _service;

    public UpdateCategoriaServiceTests()
    {
        _categoriasRepositoryMock = new Mock<ICategoriaRepository>();
        _loggerMock = new Mock<ILogger<UpdateCategoriaUseCase>>();
        _service = new UpdateCategoriaUseCase(_categoriasRepositoryMock.Object, _loggerMock.Object);
    }
