...
public class GetAllRolesServiceTests
{
    ...
    private readonly Mock<ILogger<GetAllRolesUseCase>> _loggerMock;
    private readonly GetAllRolesUseCase _getAllRolesService;

    public GetAllRolesServiceTests()
    {
        _roleRepositoryMock = new Mock<IRoleRepository>();
        _loggerMock = new Mock<ILogger<GetAllRolesUseCase>>();
        _getAllRolesService = new GetAllRolesUseCase(_roleRepositoryMock.Object, _loggerMock.Object);
    }
