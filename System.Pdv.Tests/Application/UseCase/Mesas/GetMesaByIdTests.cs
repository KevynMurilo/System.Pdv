...
public class GetMesaByIdServiceTests
{
    ...
    private readonly Mock<ILogger<GetMesaByIdUseCase>> _loggerMock;
    private readonly GetMesaByIdUseCase _service;

    public GetMesaByIdServiceTests()
    {
        _mesaRepositoryMock = new Mock<IMesaRepository>();
        _loggerMock = new Mock<ILogger<GetMesaByIdUseCase>>();
        _service = new GetMesaByIdUseCase(_mesaRepositoryMock.Object, _loggerMock.Object);
    }
