...
public class CreateStatusPedidoServiceTests
{
    ...
    private readonly Mock<ILogger<CreateStatusPedidoUseCase>> _loggerMock;
    private readonly CreateStatusPedidoUseCase _service;

    public CreateStatusPedidoServiceTests()
    {
        _statusPedidoRepositoryMock = new Mock<IStatusPedidoRepository>();
        _loggerMock = new Mock<ILogger<CreateStatusPedidoUseCase>>();
        _service = new CreateStatusPedidoUseCase(_statusPedidoRepositoryMock.Object, _loggerMock.Object);
    }
